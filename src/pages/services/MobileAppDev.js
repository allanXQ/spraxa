...
const AppDevelopment = () => {
  const techs = [
    ...
    },
    {
      ...
      image: "codefile.png",
      description:
        "Both iPhone and iPad application is done on top of Objective C and is collectively called as iOS Application Development. Spraxa, as a premier iOS Application Development Company is committed to provide top quality iOS Applications. Our Expert team of iOS app Developers will help you through to fulfill your dream of a great iOS Application.",
    },
    {
  ...
  return (
    <BodyContainer>
      <SectionContainer>
        ...
        <Typography>View Screenshots of the app we designed.</Typography>
        <Box
          sx={{
            display: "flex",
            alignItems: "center",
