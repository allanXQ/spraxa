            ...
            <Grid container style={{display:'flex', flexDirection:'column', gap:10}}>
              {Terms.map((term) => (
                  <Grid item key={term.name}>
                      <Typography variant="subtitle1" style={{fontWeight:'bold'}}>{term.name}</Typography>
