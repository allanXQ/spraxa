...
const Products = () => {
  return (
    <>
        <Header/>
        <Grid container style={{display:'flex', flexDirection:'column', alignItems:'center', gap: 20, paddingTop:20}}>
        <Grid item>
            <Grid container style={{display:'flex', flexDirection:'row', gap:20, justifyContent:'center', alignItems:'center'}}>
            <Grid item style={{}}>
        ...
        <Grid item>
            <Grid container style={{display:'flex', gap:20, alignItems:'center', justifyContent:'center',}}>
            <Grid item style={{width:'50%'}}>
        ...
        <Grid item>
            <Grid container style={{display:'flex', gap:20, alignItems:'center',justifyContent:'center',}}>
                ...
                <Grid item style={{width:'50%'}}>
                    ...
                    Error tracing is easy which saves the developer time on debugging for large and small Project.
                    </Typography>            
                </Grid>
            </Grid>    
        </Grid>
