...
const Footer = () => {
  ...
  return (
    <footer
      style={{ marginTop: 20, width: "100%", backgroundColor: "#f8f9fa" }}
    >
      <Grid
        container
        xs={12}
      ...
      >
        ...
        >
          ...
          <Typography sx={{ color: "secondary.main", mt: 2 }}>
            201, 2nd floor 45 Bansal Chambers Kaushambi Ghaziabad - (U.P)
            201010, (Near Kaushambi Metro Station)
          </Typography>
        </Grid>
        ...
        <Grid item>
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            <img
              src="/images/microsoft_gold.png"
              alt="microsoft_gold"
              width={150}
            ></img>
            <img
              src="/images/reliablesite.png"
              alt="reliablesite"
              width={150}
            ></img>
          </Box>
        ...
        <Grid
          item
          sx={{
            borderTop: "1px solid secondary.main",
            width: "100%",
            display: "flex",
        ...
        >
          <Box sx={{ display: "flex", gap: 1 }}>
            <Link to="/privacy" sx={{ color: "secondary.main" }}>
              <Typography variant="bodytext" sx={{ color: "secondary.main" }}>
                Privacy Policy
              </Typography>
            </Link>
